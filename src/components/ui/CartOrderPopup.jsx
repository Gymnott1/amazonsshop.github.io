...
const CartOrderPopup = ({ cart, onClose }) => {
              ...
              {cart.map((item) => (
                <div key={item.id} className="flex mb-4">
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="mt-1">
                      <p className="text-gray-500 dark:text-gray-400">Was KSh {item.regularPrice.toLocaleString()}</p>
                      <p className="text-lg font-bold text-gray-900 dark:text-gray-100">Now KSh {item.salePrice.toLocaleString()}</p>
                    </div>
            ...
            <form onSubmit={handleSubmit} className="p-4">
              ...
              <div className="border-t pt-4 border-gray-200 dark:border-gray-700">
                <div className="flex justify-between text-lg font-bold mb-4">
                  ...
                  <span className="dark:text-gray-200">KSh {cart.reduce((acc, item) => acc + item.salePrice * item.quantity, 0).toLocaleString()}</span>
                </div>
                <button
                  type="submit"
